        ...
        <div class="container">
            <div class="signin-content">
                <div class="signin-image">
                    <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="280" height="300"
                        ...
                        <polygon
                            ...
                            fill="#2f2e41" />
                        <circle cx="707.33457" cy="77.37523" r="77.37523" fill="#536dfe" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-203.5 -174.13424)" fill="#536dfe" />
                        <path
                    ...
                    <a href="{{ route('user#registerPage') }}" class="signup-image-link">Create an account</a>
                </div>
                ...
                <div class="signin-form">
                    ...
                    <form method="POST" class="register-form" id="login-form" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            <label for="email" ><i class="zmdi zmdi-email @error('email') pb-4 @enderror"></i></label>
                            <input type="email" name="email" id="email" placeholder="Your Email" class="@error('password') is-invalid @enderror"/>
                            @error('email')
                        ...
                        <div class="form-group">
                            <label for="password"><i class="zmdi zmdi-lock  @error('password') pb-4 @enderror"></i></label>
                        ...
                        <div class="form-group">
                            <input type="checkbox" name="passShow" id="passShow" class="agree-term" />
                                        <label for="passShow" class="label-agree-term"><span><span></span></span>show password</label>
                        </div>
...
$(document).ready(function(){
    ...
    const passShow = $('#passShow');

    passShow.on('change',function() {
        if(passShow.is(':checked')){
