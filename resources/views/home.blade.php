...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="logo">
                <h1><a href="index.html"><img src="{{ asset('img/leave-icon.png') }}" class=" pe-3">SnapView</a></h1>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a href="{{ route('user#registerPage') }}">Register</a></li>
                ...
                <div class="col-12 hero-text-image">
                    <div class="row">
                        ...
                        <div class="col-lg-4 iphone-wrap">
                            ...
                            <img src="{{ asset('img/phone_2.png') }}" alt="Image" class="phone-2" data-aos="fade-right"
                                data-aos-delay="200">
                        </div>
                    </div>
                </div>
    ...
    {{-- nav bar start --}}
    {{-- <div class="nav-bar py-2 " style="border-bottom: 1px solid cyan">
        <div class="row">
            <div class="col-lg-4 ps-lg-5"><h3>View Community</h3></div>
            <div class="col-lg-3">
                <ul class="d-flex justify-content-around mt-2">
                    <li class="list-group-item"><a href="" class=" text-decoration-none">Home</a></li>
                    <li class="list-group-item"><a href="" class="text-decoration-none">Contacts</a></li>
                    <li class="list-group-item"><a href="" class="text-decoration-none">About Us</a></li>
                </ul>
            </div>
            <div class="col-lg-4 text-end row">
                    <div class="">
